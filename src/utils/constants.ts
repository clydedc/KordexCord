...
export const KORDEXCORD_TEAM = "1173520023239786538";
export const KORDEXCORD_HELPERS = "1326406112144265257";
export const KORDEXBOP_CONTRIB_ROLE_ID = "1287079931645263968";
export const VENCORD_CONTRIB_ROLE_ID = "1173343399470964856";
export const KORDEXBOT_USER_ID = "1243063117852835941";
...
export const CONTRIB_ROLE_IDS = [CONTRIB_ROLE_ID, KORDEXBOP_CONTRIB_ROLE_ID, VENCORD_CONTRIB_ROLE_ID, VC_CONTRIB_ROLE_ID];
...
export const KordexcordDevs = Object.freeze({
    nobody: {
        name: "nobody",
        id: 0n
    },
...
export const KordexcordDevsById = /* #__PURE__*/ (() =>
    Object.freeze(Object.fromEntries(
        Object.entries(KordexcordDevs)
            .filter(d => d[1].id !== 0n)
            .map(([_, v]) => [v.id, v] as const)
    ))
)() as Record<string, Dev>;
