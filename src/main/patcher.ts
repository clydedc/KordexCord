...
console.log("[Clydecord] Starting up...");
...
if (IS_VESKTOP || IS_KORDEXBOP) require.main!.filename = join(dirname(injectorPath), "..", "..", "package.json");
...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "Kordexcord");
    ...
    console.log("[Clydecord] Running in vanilla mode. Not loading Clydecord");
}

console.log("[Clydecord] Loading original Discord app.asar");
