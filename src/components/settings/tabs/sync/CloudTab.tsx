...
function CloudTab() {
    ...
    return (
        <SettingsTab title="Clydecord Cloud">
            <section className={Margins.top16}>
                <Heading>Cloud Settings</Heading>

                <Paragraph size="md" className={Margins.bottom20}>
                    Kordexcord comes with a cloud integration allowing settings to be synced across apps and devices.
                    <br />
                    We use our own <Link href="https://github.com/Kordexcord/Equicloud">Equicloud backend</Link> to provide our cloud instance with enhanced features.
                    <br />
                    Our <Link href="https://Kordexcord.org/cloud/policy">privacy policy</Link> allows you to see what information we store, how we use it, and data retention.
                    <br />
                    Equicloud is BSD 3.0 licensed so you can host it yourself if you would like.
                    <br />
                    You can swap between Kordexcord and Vencord's different cloud instances below if needed.
                </Paragraph>
                <FormSwitch
                    key="backend"
                ...
                <Grid columns={2} gap="1em" className={Margins.top8}>
                    ...
                    <Button size={Button.Sizes.MEDIUM} onClick={() => changeUrl("https://cloud.Kordexcord.org/")}>
                        Use Kordexcord's Cloud
                    </Button>
