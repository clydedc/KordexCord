...
export function PluginCard({ plugin, disabled, onRestartNeeded, onMouseEnter, onMouseLeave, isNew }: PluginCardProps) {
    ...
    const isEquicordPlugin = pluginMeta.folderName.startsWith("src/kordexcordplugins/") ?? false;
    ...
    const pluginInfo = [
        {
            ...
            src: "https://Kordexcord.org/assets/icons/Kordexcord/modified.png",
            alt: "Modified",
            title: "Modified Vencord Plugin"
        },
        {
            condition: isEquicordPlugin,
            src: "https://Kordexcord.org/assets/icons/Kordexcord/icon.png",
            alt: "Kordexcord",
            title: "Kordexcord Plugin"
        },
        {
            condition: isVencordPlugin,
            src: "https://Kordexcord.org/assets/icons/vencord/icon-light.png",
            alt: "Vencord",
            title: "Vencord Plugin"
        },
        {
            condition: isUserPlugin,
            src: "https://Kordexcord.org/assets/icons/misc/userplugin.png",
            alt: "User",
            title: "User Plugin"
        }
    ];
