...
export const ExcludedReasons: Record<"web" | "discordDesktop" | "vesktop" | "Kordexbop" | "desktop" | "dev", string> = {
    desktop: "Discord Desktop app or Vesktop/Kordexbop",
    discordDesktop: "Discord Desktop app",
    vesktop: "Vesktop/Kordexbop apps",
    Kordexbop: "Vesktop/Kordexbop apps",
    web: "Vesktop/Kordexbop apps & Discord web",
    dev: "Developer version of Kordexcord"
};
    ...
    const pluginFilter = (plugin: typeof Plugins[keyof typeof Plugins]) => {
        ...
        switch (status) {
            ...
            case SearchStatus.ENABLED:
                if (!enabled) return false;
                break;
            case SearchStatus.CLYDECORD:
                if (!PluginMeta[plugin.name].folderName.startsWith("src/kordexcordplugins/")) return false;
                break;
                    ...
                    <ErrorBoundary noop>
                        <Select
                            options={[
                                ...
                                { label: "Show Clydecord", value: SearchStatus.CLYDECORD },
