...
function Updater() {
    ...
    return (
        <SettingsTab title="Kordexcord Updater">
            <Heading>Updater Settings</Heading>
            <FormSwitch
                title="Automatically update"
                description="Automatically update Kordexcord without confirmation prompt"
            ...
            <FormSwitch
                ...
                description="Shows a notification when Kordexcord automatically updates"
