...
const SHIGGY_DONATE_IMAGE = "https://Kordexcord.org/assets/favicon.png";
...
function KordexcordSettings() {
    ...
    return (
        <SettingsTab title="Clydecord Settings">
            {(isKordexcordDonor(user?.id) || isVencordDonor(user?.id)) ? (
                <SpecialCard
                    title="Donations"
                    subtitle="Thank you for donating!"
                    description={
                        isKordexcordDonor(user?.id) && isVencordDonor(user?.id)
                            ? "All Vencord users can see your Vencord donor badge, and Kordexcord users can see your Kordexcord donor badge. To change your Vencord donor badge, contact @vending.machine. For your Kordexcord donor badge, make a ticket in Kordexcord's server."
                            : isVencordDonor(user?.id)
                                ? "All Vencord users can see your badge! You can manage your perks by messaging @vending.machine."
                                : "All Kordexcord users can see your badge! You can manage your perks by making a ticket in Kordexcord's server."
                    }
                ...
                <SpecialCard
                    ...
                    description="Please consider supporting the development of Kordexcord by donating!"
            ...
            {isAnyPluginDev(user?.id) && (
                <SpecialCard
                    ...
                    description="Since you've contributed to Kordexcord you now have a cool new badge!"
...
export default wrapTab(KordexcordSettings, "Kordexcord Settings");

export function isKordexcordDonor(userId: string): boolean {
    const donorBadges = BadgeAPI.getKordexcordDonorBadges(userId);
