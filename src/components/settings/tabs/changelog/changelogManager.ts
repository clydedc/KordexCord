...
const CHANGELOG_HISTORY_KEY = "KordexcordChangelog_History";
const LAST_SEEN_HASH_KEY = "KordexcordChangelog_LastSeenHash";
const KNOWN_PLUGINS_KEY = "KordexcordChangelog_KnownPlugins";
const KNOWN_SETTINGS_KEY = "KordexcordChangelog_KnownSettings";
const LAST_REPO_CHECK_KEY = "KordexcordChangelog_LastRepoCheck";
