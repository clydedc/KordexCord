...
async function syncSettings() {
    ...
    if (
        ...
        showNotification({
            ...
            color: "var(--yellow-360)",
            onClick: () => SettingsRouter.open("KordexcordCloud")
        });
        return;
    }
    ...
    try {
        ...
        if (Settings.autoUpdate) {
            ...
            if (Settings.autoUpdateNotification) {
                notify({
                    title: "Kordexcord has been updated!",
    ...
    if (IS_DEV) {
        ...
        if (pendingPatches.length)
            PMLogger.warn(
                ...
                "You are seeing this warning because this is a Development build of Kordexcord.",
