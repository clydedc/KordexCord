...
export default definePlugin({
    ...
    makeSettingsCategories(SectionTypes: SectionTypes) {
        return [
            ...
            {
                section: "KordexcordSettings",
                label: "Kordexcord",
                element: VencordTab,
                className: "vc-settings",
            },
            {
                section: "KordexcordPlugins",
                label: "Plugins",
    ...
    options: {
        settingsLocation: {
            ...
            description: "Where to put the Kordexcord settings section",
            options: [
    ...
    getVersionInfo(support = true) {
        ...
        if (IS_KORDEXBOP) version = `Kordexbop v${VesktopNative.app.getVersion()}`;
    ...
    getInfoRows() {
        ...
        const rows = [`Kordexcord ${gitHashShort}${getVersionInfo()}`];
