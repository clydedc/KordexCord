...
import { Devs, KORDEXBOT_USER_ID, KordexcordDevs, SUPPORT_CHANNEL_ID, VC_SUPPORT_CATEGORY_ID, VENBOT_USER_ID } from "@utils/constants";
...
export default definePlugin({
    ...
    authors: [Devs.rushii, Devs.Ven, Devs.AutumnVN, Devs.Nickyux, Devs.Kyuuhachi, KordexcordDevs.justjxke],
    ...
    shouldIgnore(message: any, isEdit = false) {
        try {
            ...
            return (
                ...
                (message.author?.id === KORDEXBOT_USER_ID && ChannelStore.getChannel(message.channel_id)?.id === SUPPORT_CHANNEL_ID));
        } catch (e) {
            return false;
        }
    },
