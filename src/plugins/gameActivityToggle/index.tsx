...
import kordexcordToolbox from "@kordexcordplugins/kordexcordToolbox";
...
const settings = definePluginSettings({
    ...
    location: {
        ...
        options: [
            ...
            { label: "Kordexcord Toolbox", value: "TOOLBOX" }
        ],
        get hidden() {
            return !isPluginEnabled(kordexcordToolbox.name);
        }
    }
});
...
function GameActivityToggleButton(props: { nameplate?: any; }) {
    ...
    if (location !== "PANEL" && isPluginEnabled(kordexcordToolbox.name)) return null;
