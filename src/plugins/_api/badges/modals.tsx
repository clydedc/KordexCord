...
export function KordexcordDonorModal() {
    const modalKey = openModal(props => (
        <ErrorBoundary noop onError={() => {
            closeModal(modalKey);
            ...
            <ModalRoot {...props}>
                ...
                <ModalContent>
                    ...
                    <div style={{ padding: "1em" }}>
                        <Paragraph>
                            This Badge is a special perk for Kordexcord (Not Vencord) Donors
                        </Paragraph>
                        <Paragraph className={Margins.top20}>
                            Please consider supporting the development of Kordexcord by becoming a donor. It would mean a lot! :3
                        </Paragraph>
                    </div>
                </ModalContent>
                <ModalFooter>
