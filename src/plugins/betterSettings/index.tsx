...
import { buildPluginMenuEntries, buildThemeMenuEntries } from "@kordexcordplugins/kordexcordToolbox/menu";
        ...
        },
        {
            ...
            replacement: [
                ...
                },
                {
                    ...
                    replace: "$&case 'KordexcordPlugins':return $self.buildPluginMenuEntries(true);$&case 'KordexcordThemes':return $self.buildThemeMenuEntries();"
                }
            ]
        },
    ],
