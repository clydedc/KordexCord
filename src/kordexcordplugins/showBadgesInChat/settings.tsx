...
const settings = definePluginSettings({
    showEquicordDonor: {
        ...
        description: "Enable to show Kordexcord Donor badges in chat.",
        hidden: true,
        default: true
    },
    EquicordDonorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Kordexcord Donor badges.",
        hidden: true,
        default: 0
    },
    showEquicordContributor: {
        type: OptionType.BOOLEAN,
        description: "Enable to show Kordexcord Contributor badges in chat.",
        hidden: true,
        default: true
    },
    EquicordContributorPosition: {
        type: OptionType.NUMBER,
        description: "The position of the Kordexcord Contributor badge.",
        hidden: true,
        default: 1
    },
    showVencordDonor: {
...
const BadgeSettings = () => {
    const [images, setImages] = useState([
        { src: "https://images.Kordexcord.org/api/files/raw/0199e71a-5555-7000-aafb-a07a355d9b28", shown: settings.store.showEquicordDonor, title: "Kordexcord donor badges", key: "EquicordDonor", position: settings.store.EquicordDonorPosition },
        { src: "https://Kordexcord.org/assets/favicon.png", shown: settings.store.showEquicordContributor, title: "Kordexcord contributor badge", key: "EquicordContributer", position: settings.store.EquicordContributorPosition },
