        ...
        >
            {(_, { isShown }) => (
                <HeaderBarIcon
                    ...
                    onClick={() => setShow(v => !v)}
                    tooltip={isShown ? null : "Kordexcord Toolbox"}
                    icon={() => <Icon />}
                    selected={isShown}
                />
            )}
...
migratePluginSettings("KordexcordToolbox", "VencordToolbox");
export default definePlugin({
    name: "KordexcordToolbox",
    description: "Adds a button next to the inbox button in the channel header that houses Kordexcord quick actions",
