...
import { addMessagesBulkIDB, DBMessageRecord, getAllMessagesIDB } from "@kordexcordplugins/messageLoggerEnhanced/db";
...
export async function exportLogs() {
    ...
    if (IS_WEB || IS_VESKTOP || IS_KORDEXBOP || !DiscordNative) {
