...
export default definePlugin({
    ...
    authors: [KordexcordDevs.SomeAspy, Devs.thororen],
    dependencies: ["AudioPlayerAPI"],
    settings,
    start() {
        croissant = createAudioPlayer("https://github.com/Kordexcord/Equibored/raw/main/sounds/equissant/croissant.mp3", { persistent: true });
