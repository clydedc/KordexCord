...
import { getLyrics, lyricFetchers, providers, updateLyrics } from "@kordexcordplugins/musicControls/spotify/lyrics/api";
import { SpotifyStore, type Track } from "@kordexcordplugins/musicControls/spotify/SpotifyStore";
