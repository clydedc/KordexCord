...
import { LyricsData, Provider } from "@kordexcordplugins/musicControls/spotify/lyrics/providers/types";
import { Track } from "@kordexcordplugins/musicControls/spotify/SpotifyStore";
...
export async function getLyricsLrclib(track: Track): Promise<LyricsData | null> {
    ...
    const response = await fetch(url, {
        headers: {
            "User-Agent": "SpotifyLyrics for Kordexcord (https://github.com/Masterjoona/vc-spotifylyrics)"
        }
    });
