...
import { providers } from "@kordexcordplugins/musicControls/spotify/lyrics/api";
import { lyricsAlternative } from "@kordexcordplugins/musicControls/spotify/lyrics/providers/store";
