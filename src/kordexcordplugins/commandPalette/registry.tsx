...
import { toggleEnabled } from "@kordexcordplugins/kordexcordHelper/utils";
...
const BUILT_IN_CATEGORIES: CommandCategory[] = [
    {
        ...
        label: "Quick Actions",
        description: "Common Kordexcord shortcuts"
    },
    {
        id: "plugins",
        label: "Plugins",
        description: "Manage Kordexcord and Vencord plugins"
    },
    {
    ...
    },
    {
        id: "updates",
        label: "Updates",
        description: "Stay up to date with Kordexcord"
    },
    {
        id: "discord-settings",
...
const BUILT_IN_COMMANDS: CommandEntry[] = [
    {
        id: "open-Kordexcord-settings",
        label: "Open Clydecord Settings",
        keywords: ["settings", "Kordexcord"],
        categoryId: DEFAULT_CATEGORY_ID,
        tags: [TAG_NAVIGATION, TAG_CORE],
        handler: () => SettingsRouter.open("KordexcordSettings")
    },
    {
        ...
        handler: () => SettingsRouter.open("KordexcordPlugins")
    },
    {
        id: "reload-windows",
...
function registerUpdateCommands() {
    registerCommand({
        ...
        description: "Checks for Kordexcord updates",
    ...
    registerCommand({
        ...
        description: "Opens the Kordexcord changelog",
        keywords: ["updates", "changelog"],
        categoryId: "updates",
        tags: [TAG_DEVELOPER, TAG_NAVIGATION],
        handler: () => SettingsRouter.open("KordexcordChangelog")
    });
}
...
function registerPluginChangeCommands() {
    ...
    registerCommand({
        id: "restart-Kordexcord",
        label: "Restart Kordexcord",
...
function registerCustomizationCommands() {
    ...
    registerCommand({
        ...
        handler: () => SettingsRouter.open("KordexcordThemes")
    });
}
