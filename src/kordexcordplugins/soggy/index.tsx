...
import { KordexcordDevs } from "@utils/constants";
...
const settings = definePluginSettings({
    ...
    imageLink: {
        ...
        type: OptionType.STRING,
        default: "https://images.Kordexcord.org/api/files/raw/0199e730-70d5-7000-a44f-d1acb42064cc",
    },
    songLink: {
        description: "URL for the song to play",
        type: OptionType.STRING,
        default: "https://github.com/Kordexcord/Equibored/raw/main/sounds/soggy/song.mp3?raw=true",
        onChange(newValue) {
    ...
    boopLink: {
        ...
        type: OptionType.STRING,
        default: "https://github.com/Kordexcord/Equibored/raw/main/sounds/soggy/honk.wav?raw=true",
        onChange(newValue) {
