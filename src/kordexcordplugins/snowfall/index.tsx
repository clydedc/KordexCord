...
export default definePlugin({
    ...
    authors: [KordexcordDevs.ZcraftElite, KordexcordDevs.square],
    ...
    settingsAboutComponent: () => (
        <>
            ...
            <Paragraph>
                ...
                <br /><br />
                NOTE: While on most computers this plugin will not impact performance any more than your average Kordexcord extension,
