...
const buildConfigs = [
    ...
    },
    {
        ...
        outfile: "dist/Kordexcord.user.js",
        banner: {
...
async function buildExtension(target, files) {
    const entries = {
        "dist/Kordexcord.js": await readFile("dist/browser/extension.js"),
        "dist/Kordexcord.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/Kordexcord.user.css", "utf-8").then(content => {
    const cssRuntime = `
...
`;
    ...
    return appendFile("dist/Kordexcord.user.js", cssRuntime);
});
